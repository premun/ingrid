...
<solution name="premun.mps.ingrid.plugin" uuid="66ae852b-d084-4d2e-b9bc-dad381ea9aea" moduleVersion="0" compileInMPS="true">
  <models>
    ...
    <modelRoot contentPath="/home/premun/Diplomka/ingrid/lib" type="java_classes">
      ...
      <excluded location="premun.mps.ingrid.importer.jar" />
      <excluded location="mps" />
      <excluded location=".gitignore" />
      <excluded location="antlr-4.5.2-complete.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
  ...
  <dependencies>
    ...
    <dependency reexport="false">8f833572-184a-4705-be72-ff2712986984(premun.mps.ingrid.plugin.import_action)</dependency>
  </dependencies>
  <languageVersions>
  ...
  <dependencyVersions>
    ...
    <module reference="66ae852b-d084-4d2e-b9bc-dad381ea9aea(premun.mps.ingrid.plugin)" version="0" />
