...
<solution name="premun.mps.ingrid.plugin.import_action" uuid="8f833572-184a-4705-be72-ff2712986984" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
  ...
  <sourcePath />
  <dependencies>
    <dependency reexport="false">fe246be5-ce3c-4829-8cc0-4a7d01deb23f(premun.mps.ingrid.plugin.importer)</dependency>
